...
# HAC_LAGS = 5
# ROLL = 126
# OUT = Path("data/FACTOR/ai_betas.parquet")
...
# def main() -> int:
#     rets = pd.read_parquet("data/FACTOR/prices.parquet")
#     rets.index = pd.to_datetime(rets.index)
#     if getattr(rets.index, "tz", None) is not None:
#         rets.index = rets.index.tz_localize(None)
#     fac = pd.read_parquet("data/FACTOR/ai_factor.parquet")
...
#     roll.to_parquet("data/FACTOR/ai_betas_rolling.parquet")
...
OUT = Path("data/FACTOR/ai_betas.parquet")
OUT_TXT = Path("data/FACTOR/ai_betas.txt")

ROLLING_OUT = Path("data/FACTOR/ai_betas_rolling.parquet")
ROLLING_OUT_TXT = Path("data/FACTOR/ai_betas_rolling.txt")
